class responsiveTree
{
    ...
    draw() {
         ...
         let angleDegrees = (mouseX / width) * 90; // calculates the angle in degrees based on the mouseX position, which wil be used to add interactivity to the branches later
